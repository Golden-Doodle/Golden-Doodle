...
import { Calendar } from "react-native-calendars"; // Calendar for Date Selection
import * as ImagePicker from "expo-image-picker";  // Image Picker
import TimePicker from "../TimePicker";            // Time Picker Component
...
const styles = StyleSheet.create({
    ...
    reportInput: {
        // Additional styling for the multiline report input
        height: 100,
